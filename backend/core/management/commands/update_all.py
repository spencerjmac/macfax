...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=10,
            help='Number of iterations for adjusted ratings (default: 10)'
        )
        parser.add_argument(
            '--sor-trials',
            type=int,
    ...
    def handle(self, *args, **options):
        ...
        if not skip_ingest:
            try:
                ...
                self.stdout.write(self.style.SUCCESS("✅ Game logs ingested\n"))
            except Exception as e:
                steps.append(("Ingest game logs", False, str(e)))
                self.stderr.write(self.style.ERROR(f"❌ Failed: {e}\n"))
                failed = True
        else:
            self.stdout.write("\n⏭️  [1/8] Skipping game ingestion\n")
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✅ Team metrics computed\n"))
        except Exception as e:
        ...
        try:
            self.stdout.write(f"⚙️  [3/8] Computing adjusted ratings ({iterations} iterations)...")
            ...
            self.stdout.write(self.style.SUCCESS("✅ Adjusted ratings computed\n"))
        except Exception as e:
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✅ Four factor index computed\n"))
        except Exception as e:
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✅ NET rankings fetched\n"))
        except Exception as e:
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✅ SOR computed\n"))
        except Exception as e:
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✅ Game values computed\n"))
        except Exception as e:
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✅ SOS computed\n"))
        except Exception as e:
        ...
        if not failed:
            ...
            self.stdout.write(self.style.ERROR("⚠️  UPDATE COMPLETED WITH ERRORS"))
        self.stdout.write("="*80)
        ...
        for step_name, success, error in steps:
            if success:
                if error == "Skipped":
                    self.stdout.write(f"  ⏭️  {step_name}: Skipped")
                else:
                    self.stdout.write(self.style.SUCCESS(f"  ✅ {step_name}"))
            else:
                self.stdout.write(self.style.ERROR(f"  ❌ {step_name}: {error}"))
        ...
        if failed:
            self.stdout.write(self.style.WARNING("⚠️  Some steps failed. Check errors above."))
            sys.exit(1)
        else:
