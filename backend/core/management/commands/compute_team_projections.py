...
from core.analytics.player_value.team_projection.service import (
...
class Command(BaseCommand):
    ...
    def _print_validation(self, season_year: int) -> None:
        ...
        from core.models import TeamSeasonProjection  # noqa: PLC0415
        bottom = list(
    ...
    def _print_validation_from_objects(self, projections: list) -> None:
        ...
        from core.models import Team  # noqa: PLC0415
