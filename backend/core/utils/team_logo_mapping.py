"""
Mapping of Team.name (and common variants) to logo filename stem in web/public/logos.
Used by the import_logos management command to set Team.logo_url.
Logo files are named like alabama_crimson_tide.png (ESPN-style).
"""

# Team display name -> logo file stem (filename without extension)
TEAM_NAME_TO_LOGO_STEM = {
