...
from ncaa.models import Game, Season
from ncaa.utils.ncaa_api import NCAAAPIClient, NCAAAPIError
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        from ncaa.management.commands.ingest_gamelogs import Command as IngestCommand
